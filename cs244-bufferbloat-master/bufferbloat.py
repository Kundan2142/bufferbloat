...
class BBTopo(Topo):
    ...
    def build(self, n=2):
        ...
        print "Making the links from host h1 to switch"
        #setting link from h1 to router with bandwidth 1 Gb/s and 6ms delay
        ...
        # Link from Router to h2. 10 Mb/s, 6ms delay.
